...
type HttpRequest struct {
	...
	DisableRedirect bool              `protobuf:"varint,6,opt,name=disable_redirect,json=disableRedirect,proto3" json:"disable_redirect,omitempty"`                                                 // 是否禁用自动重定向
}
...
func (x *HttpRequest) GetDisableRedirect() bool {
	if x != nil {
