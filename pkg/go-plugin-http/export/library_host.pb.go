...
func Instantiate(ctx context.Context, r wazero.Runtime, hostFunctions HttpLibrary) error {
	envBuilder := r.NewHostModuleBuilder("http-library")
	h := _httpLibrary{hostFunctions}

	envBuilder.NewFunctionBuilder().
		WithGoModuleFunction(api.GoModuleFunc(h._DoRequest), []api.ValueType{i32, i32}, []api.ValueType{i64}).
...
func (h _httpLibrary) _DoRequest(ctx context.Context, m api.Module, stack []uint64) {
